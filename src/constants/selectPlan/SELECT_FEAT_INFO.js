...
export const SELECT_FEAT_INFO = [
    {
      ...
      Image: 'src/assets/feat_card1.png',
    },
    {
      ...
      Image: 'src/assets/feat_card2.png',
    },
    {
      HeaderText: '자신의 방식대로\n시간에 집중하세요',
      SubText:
      ...
      Image: 'src/assets/feat_card3.png',
    },
  ];

export const Feat_link_card =[
    {HeaderText: "NUWA의 사용법과 기능에 대해서 알아보세요", Icon: "📝", LinkText: "기능 알아보기"},
    {HeaderText: "NUWA를 사용 중인 분들의 이야기를 만나 보세요", Icon: "🙋🏻‍♀️", LinkText: "스토리 읽기"},
    {HeaderText: "당신의 팀에 어떤 도움을 주는지 알아보세요", Icon: "✍🏻", LinkText: "솔루션 살펴보기"},
    {HeaderText: "초보자를 위한 가이드를 지금 만나 보세요", Icon: "💡", LinkText: "방법 알아보기"},
]

export const Sub_Feat = [
    {Image: KanbanBoard, Icon: CircleOne, MainText:"칸반보드로 업무를\n한 눈에 확인!"},
    {Image: Calen, Icon: CircleTwo, MainText:"개인적인 일정은 물론\n업무 효율 캘린더" },
    {Image: TodoList, Icon: CircleThree, MainText:"하루의 계획을\n작성해 보세요"}
]

export const FAQ_text =[
  {
  QuestionText: "워크스페이스 아이콘 이미지는 어디서 변경하면 되나요?", 
  AnswerText: "NUWA 대쉬보드에 접속 후 사이드 바 프로필 상단 워크스페이스 이름을 클릭하시면 워크스페이스 이름 수정과 아이콘 변경하는 창이 나옵니다."
  },
  ...
  {
    QuestionText: "슬랙에 스레드와 NUWA의 스레드는 다른 것 같은데 다른 점이 뭔가요?", 
    AnswerText: "NUWA 대쉬보드에 접속 후 사이드 바 프로필 상단 워크스페이스 이름을 클릭하시면 워크스페이스 이름 수정과 아이콘 변경하는 창이 나옵니다."
  },
